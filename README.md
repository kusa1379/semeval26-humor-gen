**SemEval-2026 Humor Generation Subtasks A1, A2, B1, B2 (EN / ES / ZH + Multimodal GIF Humor)** 
...
Task A1 (Text-only): Given two words, generate a joke that uses both.

Task A2 (Text-only): Given a news-like headline, generate a humorous reaction.

Task B1 (Multimodal): Given a GIF URL, generate a humorous caption based only on the GIF.

Task B2 (Multimodal): Given a GIF URL + text prompt, generate a humorous caption that relates to both.
...
src/ — Source Code prompts.py — All Prompts in One Place
...
3. Tasks Brief Explanations 3.1 Task A1 — Two-Word Humor
...
import os os.environ["OPENAI_API_KEY"] = "sk-..." (# your API Key)
